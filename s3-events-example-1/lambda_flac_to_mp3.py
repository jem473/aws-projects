'''A basic AWS Lambda function example for converting audio files to
...
def handle_object_removed(object_key: str):
...
pathlib instead...'''
def change_file_extension(filename: str, replacement: str) -> str:
